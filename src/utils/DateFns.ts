...
class DateFns {
  ...
  public format(date: Date | number, pattern: string, options?: Parameters<typeof _format>[2]) {
...
export const { IsValid, format, compare, Compare, EndOfDay, StartOfDay } = instance;
